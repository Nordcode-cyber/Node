...
function solicitudServicio(consulta, callback){
  setTimeout(function(){
    var respuesta1 = consulta + "tracking variables...";
    callback(respuesta1);
  },4000);
}

function obtenerServicio(resultado){
  console.log("Respuesta del servicio: " + resultado);
}
arr = ['tempetura: 23 |'+'humedad: 56 |'+'viento: Sur |'+'Hp: 45 ..']
solicitudServidor(arr, obtenerServicio); 